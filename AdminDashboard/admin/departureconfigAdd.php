	...
	<?php
	 ...
	 if(isset($_POST["sub"])){
		 if($err == 0){
			 ...
			 $departure->CounterId = $_POST["counterid"];
                    	...
                    	<form action="" class="mws-form" method="post">
                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Bus Name</label>
                                    <div class="mws-form-item">
                                        <div class="mws-form-cols">
                                            <div class="mws-form-col-3-8">
                                                <select name="busid" class="mws-select2 large">
                                    ...
                                    <div class="mws-form-item">
                                        <div class="mws-form-cols">
                                            <div class="mws-form-col-3-8">
                                                ...
                                                <select name="station_from" class="mws-select2 large">
                                    				<option value="">Starting_From</option>
                                      				<?php
                          ...
                          <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Starting To</label>
                                    <div class="mws-form-item">
                                        <div class="mws-form-cols">
                                            <div class="mws-form-col-3-8">
                                            
                                            	<select name="station_to" class="mws-select2 large">
                           ...
                           <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">ViaCounter</label>
                                    <div class="mws-form-item">
                                        <div class="mws-form-cols">
                                            <div class="mws-form-col-3-8">
                                    			...
                                    			<option value="">ViaCounter</option>
                                      				<?php 
                        ...
                        <table class="mws-table" id="data-table">
							...
							?>
                                <tr>
                                    ...
                                    <td><?php echo $r[$i]["CounterName"]; ?></td>
                                    ...
                                    <td><a title="Edit" href="?a=stationEdit&id=<?php echo $r[$i]["id"]; ?>"><i class="icon-edit"></i></a></td>
